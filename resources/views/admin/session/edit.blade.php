    ...
    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 col-lg-offset-3">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                    <form action="{{route('timeslot.update', $slotinf['id'])}}" method="POST">
                        @method('PUT')
                        @csrf
                ...
                @if ($errors->any())
                    ...
                    @endif
                        @if(isset($slotinf))
                            ...
                            <div class="form-line">
                            <input type="text" id="slot" class="form-control" placeholder="Enter Slot Name" name="slot" value="{{$slotinf['slot_name']}}" />
                            </div>
                            </div>
                            <div class="form-group">
                            <label for="start">Starting Time</label>
                            <div class="form-line">
                                <input id="starting" type="text" class="form-control" placeholder="Enter Starting Time" name="start" value="{{$slotinf['start']}}"/>
                            </div>
                            </div>
                            <div class="form-group">
                                <label for="end">Ending  Time</label>
                                <div class="form-line">
                                    <input id="ending" type="text" class="form-control" placeholder="Enter Ending Time" name="end" value="{{$slotinf['end']}}" />
                                </div>
                            </div>
