...
@endif
                ...
                <div class="demo-checkbox">
                    ...
                    <input type="checkbox" id="{{$item->id}}" class="filled-in chk-col-{{$color[rand(1,17)]}}" value="{{$item->id}}" name="area[]"  @foreach($RouteWiseAreaInformation as $bus_route)
                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <select class="form-control show-tick " name="bus">
                            ...
                            <option value="{{$busdata->id}}">{{$busdata->bus_name}}</option>
                            @endforeach
                        </select><br><br><br>
